...
func Routers() *gin.Engine {
	...
	}
	{
		...
		attendantRouter.InitAttendantRouter(PublicGroup) // 注册考勤相关
	}
	...
	PrivateGroup.Use(middleware.JWTAuth()).Use(middleware.CasbinHandler())
	{
		...
		autocodeRouter.InitSysDepartmentRouter(PrivateGroup)
		autocodeRouter.InitAutoPositionRouter(PrivateGroup)
